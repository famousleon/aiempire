...
**支持 6 种语言**：中文、English、Español、العربية、Português、日本語（自动 RTL 支持）
...
```
AiEmpire/
├── index.html          # 主页面（含 data-i18n 属性）
├── css/
│   └── style.css       # Apple 风格样式（含 RTL 支持）
├── js/
│   ├── i18n.js         # 国际化翻译系统（6种语言）
│   ├── app.js          # 主应用逻辑
│   ├── tasks.js        # 任务管理系统
│   ├── news.js         # 新闻集成
│   ├── proof.js        # 照片证明系统
